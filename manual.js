    ...
    const usageHtml = `
        <div class="bg-white rounded-lg shadow p-6 space-y-6">
            ...
            <section class="space-y-3">
                ...
                <ul class="list-disc list-inside space-y-2 text-gray-600">
                    ...
                    <li><strong>ライフリスト:</strong>
                        ...
                        編集画面で手動でもON/OFFできますが、「イベント」タブからの自動更新が便利です。
                    </li>
                </ul>
            </section>
            ...
            <section class="space-y-3">
                ...
                <p class="text-sm text-gray-600">
                    日々の探鳥会や観察記録を「イベント」として保存できます。
                </p>
                <ul class="list-disc list-inside space-y-2 text-gray-600">
                    <li><strong>イベント作成:</strong> 「新規イベント作成」ボタンから、日付、場所、天気、同行者などの基本情報を記録できます。</li>
                    <li><strong>観察記録:</strong>
                        作成したイベントの詳細画面で、「観察した鳥」（名前、数、確認方法）を追加できます。
                    </li>
                    <li><strong>図鑑との連携:</strong>
                        イベントに鳥を登録すると、図鑑アプリが以下の処理を自動で行います。
                        <ul class="list-inside list-disc ml-4 mt-1 text-sm">
                            <li>図鑑側の「最新の観察日」「最新の観察場所」をイベント情報で更新します。</li>
            ...
            <section class="space-y-3">
                ...
                <p class="text-sm text-gray-600">
                    設定：アプリの各種設定、データ管理、「バーダーカード」機能が含まれます。
                </p>
                <ul class="list-disc list-inside space-y-2 text-gray-600">
                    <li><strong>バーダーカード:</strong>
                        <ul class="list-inside list-disc ml-4 mt-1 text-sm">
                            <li>あなたの名前とお気に入りの写真、ライフリストの集計結果が載った「名刺」を作成できます。</li>
                    ...
                    <li><strong>背景設定:</strong> アプリの背景色や、背景画像（及び透過度）を自由に変更できます。</li>
                </ul>
            </section>
            ...
            <section class="space-y-3">
                ...
                <div class="bg-red-50 border border-red-200 rounded-lg p-4 space-y-3">
                    <h4 class="font-semibold text-red-800">1. データは「あなたのブラウザ」にのみ保存</h4>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
                    ...
                    <p class="text-sm text-blue-700">
                        データを守るため、定期的に「設定」タブ →「データ管理」にある「データのエクスポート」を実行してください。
                    </p>
                    <p class="text-sm text-blue-700">
                 ...
                 <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 space-y-3">
                    ...
                    <p class="text-sm text-yellow-700
                        「データのインポート」を実行すると、現在のデータはすべて消去され、ファイルの内容で完全に上書きされます。ご注意ください。
                    </p>
                </div>
            </section>
        </div>
    ...
    const precautionsHtml = `
        <div class="bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <ul class="list-disc list-inside space-y-2 text-gray-600">
                ...
                <li><strong>餌を与えない:</strong> 人間の食べ物は鳥にとって有害です。人や鳥の感染症を広げる、行動を変化させることで生存を難しくする（本来の食物を得る事ができなくなる）、農作物の食害や人への攻撃行動を増加させ駆除される、人への警戒心が薄れ密猟や事故を助長する等によって生態系のバランスを崩す原因となります。</li>
            ...
            <ul class="list-disc list-inside space-y-2 text-gray-600">
                ...
                <li><strong>自然を壊さない:</strong> 撮影のために枝を折ったり、構造物を設置したりする行為は絶対にやめましょう。</li>
            </ul>
            ...
            <ul class="list-disc list-inside space-y-2 text-gray-600">
                ...
                <li><strong>他の観察者への配慮:</strong> 三脚を立てる場所や移動の際は、お互いに譲り合いましょう。珍しい鳥の情報を共有する際は、鳥に過度なプレッシャーがかからないよう公開する範囲に配慮しましょう。</li>
