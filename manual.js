...
function showManualPage() { 
    ...
    const precautionsHtml = `
        <div class="bg-white rounded-lg shadow p-6 space-y-4">
            <h2 class="text-xl font-semibold mb-4">野鳥観察（バーディング）の心構え</h2>
            <p class="text-gray-700">
            ...
            <ul class="list-disc list-inside space-y-2 text-gray-700">
                <li><strong>距離を保つ:</strong> 鳥が警戒したり、逃げたりしないよう、十分な距離を保ちましょう。特に巣やヒナには絶対に近づかないでください。</li>
                <li><strong>ストレスを与えない:</strong> しつこく追いかけ回したり、大声を出したりしないでください。</li>
                <li><strong>餌を与えない:</strong> 人間の食べ物は鳥にとって有害であり、生態系のバランスを崩す原因となります。</li>
